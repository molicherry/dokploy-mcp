...
export class DokploySkill {
  ...
  constructor(config: SkillConfig, toolExecutor: (name: string, args: any) => Promise<any>) {
    this.config = config;
    this.toolExecutor = toolExecutor;
    this.router = new CategoryRouter();
    this.workflowEngine = new WorkflowEngine(
      (name, args) => this.toolExecutor(name, args),
  ...
  getToolsByCategory(category: string): string[] {
    ...
    for (const subcategory of Object.values(config.subcategories)) {
      tools.push(...subcategory);
    }
...
export { CategoryRouter, WorkflowEngine };
export * from './types.js';
export * from './workflows/index.js';
export { categoryMap, crossCategoryWorkflows } from './utils/category-router.js';
